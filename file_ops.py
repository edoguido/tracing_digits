...
def recordSession(data):
    ...
    file_path = "%s%s%s%s%s" % ('/home/drivinward/trdi/sessions/', date, '/', date, '.json')
    ...
    if os.path.exists(file_path):
        ...
        os.makedirs('/home/drivinward/trdi/sessions/'+date)
...
#     date = datetime.datetime.today().strftime('%Y-%m-%d')
#     file_path = "%s%s%s" % ('/home/drivinward/trdi/sessions/', date, '.json')
#     file_size = os.stat(file_path).st_size
